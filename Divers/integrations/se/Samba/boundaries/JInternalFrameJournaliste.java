 ...
 * @author formation
 */
public class JInternalFrameJournaliste extends javax.swing.JInternalFrame {
     ...
     */
    public JInternalFrameJournaliste() {
        initComponents();
        Object[] tDataLigne;
        remplirTable();
    }
    ...
    private void initComponents() {
        ...
        if (jTableJournaliste.getColumnModel().getColumnCount() > 0) {
            ...
            jTableJournaliste.getColumnModel().getColumn(2).setCellEditor(null);
        }
