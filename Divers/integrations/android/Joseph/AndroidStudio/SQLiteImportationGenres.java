...
/**
 * Created by Administrateur on 06/11/2017.
 */
...
public class SQLiteImportationGenres extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_GENRE = "CREATE TABLE IF NOT EXISTS genre(id_genre INTEGER PRIMARY KEY AUTOINCREMENT, code_genre CHAR(2) NOT NULL UNIQUE, libelle_genre VARCHAR(50) NOT NULL UNIQUE, genre_grammatical CHAR(1) NOT NULL)";
