 ...
 * Created by Jessica
 */
public class TAExterneArrondissement extends AsyncTask<String, Integer, String> {

    //private TextView textViewMessage;
    private MyCallBackInterface callback;

    public TAExterneArrondissement(MyCallBackInterface callback) {
        //super();
...
//        } else {
//            textViewMessage.setText(asResultat.trim());
//        } /// if

        callback.onTaskFinished(asResultat);
    } /// onPostExecute
