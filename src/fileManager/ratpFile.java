 ...
 * @author formation
 */
public class ratpFile {

//    public ratpFile() {
//
//    }

    public static String cleanDuplicatesData(String fileName) {
        String retFile = "metro_paris.txt";
...
//                System.out.println(lsbContenu.toString());
                FileWriter lfwFichier = new FileWriter(retFile);
