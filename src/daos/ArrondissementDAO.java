...
public class ArrondissementDAO {
    ...
    public Arrondissement selectOne(String arrondissement) {
        ...
        try {
            PreparedStatement lpst = icnx.prepareStatement("CALL cinescope.arrondissementSelectOne(?)");
    ...
    public List<Arrondissement> selectAll() {
        ...
        try {
            PreparedStatement lpst = icnx.prepareStatement("CALL cinescope.arrondissementSelectAll()");
            ResultSet lrs = lpst.executeQuery();
            while (lrs.next()) {
                Arrondissement a = new Arrondissement();
    ...
    public int insert(Arrondissement objet) {
        ...
        try {
            PreparedStatement lpst = icnx.prepareStatement("CALL cinescope.arrondissementInsert(?,?)");
    ...
    public int update(Arrondissement objet) {
        ...
        try {
            PreparedStatement lpst = icnx.prepareStatement("CALL cinescope.arrondissementUpdate(?,?,?)");
            lpst.setString(1, objet.getCodeArrondissement());
            lpst.setString(2, objet.getNomArrondissement());
    ...
    public int delete(Arrondissement objet) {
        ...
        try {
            PreparedStatement lpst = icnx.prepareStatement("CALL cinescope.arrondissementDelete(?)");
